...
# abCMS
## Note: Images are not sanitized of metadata. This is an intentional design choice. IF you don't want your data on here, deal with it yourself.
...
## Tests
1. Install dependencies via `setup.sh` or `nix-shell`.
2. Run `busted` from the repository root.
